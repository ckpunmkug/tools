...
run /usr/bin/mkdir -p ${MOUNT_POINT}/boot/efi
run /usr/bin/mount ${EFI_DEVICE} ${MOUNT_POINT}/boot/efi
...
run /usr/bin/mount -t efivarfs efivars ${MOUNT_POINT}/sys/firmware/efi/efivars
